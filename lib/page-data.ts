...
export const pageContents: PageContent[] = [
  ...
  // ===================================================================
  {
    ...
    leftPhotos: [
      {
        src: "/KRUFAV/assets/img/tf1.jpeg",
        alt: "Muji",
        variant: "polaroid",
        rotation: -4,
      },
      {
        src: "/KRUFAV/assets/img/p1.jpg",
        alt: "Angkringan",
        variant: "polaroid",
        rotation: 3,
      },
