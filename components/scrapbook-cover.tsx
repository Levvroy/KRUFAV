  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 left-8 md:left-12 p-4 md:p-8 flex flex-col items-center justify-center">
        ...
        <Doodle type="underline" className="w-32 md:w-48 h-3 mt-1 opacity-60" />

        {/* Main photo frame - larger */}
        <motion.div
        ...
        >
          <TapeElement rotation={-12} variant="washi" className="absolute -top-4 left-[15%] z-10" />
          <TapeElement rotation={10} variant="masking" className="absolute -top-3 right-[15%] z-10" />
          <PhotoFrame
        ...
        >
          <div className="absolute top-0 left-0 right-0 h-4 bg-yellow-300" />
          <p className="font-sans text-[9px] md:text-[11px] text-gray-700 p-2 pt-5 leading-tight">
            Don't forget to smile!
          </p>
          <Doodle type="heart" className="absolute bottom-2 right-2 w-4 h-4 opacity-50" />
        </motion.div>
