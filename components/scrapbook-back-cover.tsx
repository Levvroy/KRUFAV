  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 right-8 md:right-12 p-6 md:p-10 flex flex-col items-center justify-center gap-6">
        ...
        >
          <p className="font-sans text-lg md:text-xl text-amber-300">Thanks for visiting my scrapbook!</p>
          <p className="font-sans text-base text-amber-400 italic">Every page holds a piece of my journey.</p>
        </motion.div>
        ...
        >
          ...
          <p className="font-[var(--font-marker)] text-lg text-amber-300">- Your Name</p>
        </motion.div>
      </div>
